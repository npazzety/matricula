...
public class ClasesController {
    ...
    @GetMapping("obtenerClases/{idClase}")
    public RequisitosClaseDTO getMethodName(@RequestBody RequisitosClaseDTO requisitosClases) {
        return this.clasesServiceImpl.obtenerRequisitosClases(requisitosClases);
    }
}
